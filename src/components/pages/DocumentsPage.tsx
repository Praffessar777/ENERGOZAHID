...
export function DocumentsPage() {
  ...
  const documents = [
    ...
    },
    {
      ...
      type: 'Довідник',
      format: 'PDF',
      viewLink: '/pdf/Контактні дані для подання повідомлень про загрозу електробезпеці.pdf',
      downloadLink: '/pdf/Контактні дані для подання повідомлень про загрозу електробезпеці.pdf'
    },
    {
      id: 33,
      category: 'consumer-info',
